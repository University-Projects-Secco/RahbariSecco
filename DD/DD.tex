...
\begin{tabular}{|c|c|c|c|}
	...
	\hline
	Mobile Application				&High							&								&Medium to High							\\ %TODO
	\hline
	...
	\hline
	JSP								&								&High							&Buy (free,low)							\\ %TODO
	\hline
	Notification Manager				&Medium							&Medium to Low					&Low										\\ %TODO
	\hline
	Map Builder						&High							&High							&Cloud (cheap,medium)					\\ %TODO
	\hline
	Top Violators Ranking Builder	&Low to Medium					&								&Low										\\ %TODO
	\hline
	Computer Vision Engine			&Medium to High					&Medium to High					&Cloud (cheap,medium to high)			\\
	\hline
	Data Mining Engine				&								&Medium to High					&High									\\ %TODO
	\hline
	Ticket Manager					&								&High							&Low										\\
	\hline
	Camera Manager					&Medium							&High							&Medium to Low							\\ %TODO
	\hline
	GPS Manager						&Medium							&Medium							&Medium to Low							\\ %TODO
	\hline
	Current Time Manager				&Medium							&Medium							&Low										\\ %TODO
	\hline
...
\end{center}
\end{table}
Analyzing the table, we plan to implement/configure the components according the following schedule:
\begin{table}[H]
\begin{center}
\begin{tabular}{|c|c|c|}
		\hline
		\textbf{Implementation Phase}				&\textbf{Adopted solution}					&\textbf{Covered Components}		\\
		\hline
		\multirow{4}{*}{Prototype}					&Amazon S3									&DBMS							\\
													\cline{2-3}
													&\multirow{2}{*}{Tomcat Web Server}			&Rest Api						\\
													&											&HTML Server						\\
													\cline{2-3}
													&Custom made Application						&Mobile Application				\\
													\cline{2-3}
													&JSP											&JSP								\\
		\hline
		\multirow{3}{*}{Basic logic}					&Amazon Rekognition							&Computer Vision Engine			\\
													\cline{2-3}
													&Google Cloud: Maps							&Map Builder						\\
													\cline{2-3}
													&Custom controller							&Ticket Manager					\\
		\hline		
		\multirow{4}{*}{Authentication}				&\multirow{3}{*}{Amazon cognito}				&Authentication Manager			\\
													&											&Signup Controller				\\
													&											&Encryption Service				\\
													\cline{2-3}
													&Amazon Simple Mail							&Mail Server						\\
		\hline		
		\multirow{3}{*}{Mobile Security}				&\multirow{3}{*}{Mobile Application Update}	&Camera Manager					\\
													&											&GPS Manager						\\
													&											&Current Time Manager			\\
		\hline
		\multirow{3}{*}{Extended features}			&\multirow{3}{*}{Custom controllers}			&Data Mining Engine				\\
													&											&Notification Manager			\\
													&											&Top Violators Ranking Builder	\\
		\hline
\end{tabular}
\end{center}
\end{table}
\begin{enumerate}
	\item Citizen prototype
		\begin{enumerate}
		\item DBMS
		\item Rest API
	...
	\item Ticket Manager
	\item Computer Vision Engine
	\item Amazon cognito (Signup Controller, Authentication Manager, Encryption Service)
	\item Tomcat Web Server (HTML server, Rest Api)
	\item Amazon simple email service (Mail server)
