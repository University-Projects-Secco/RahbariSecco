		...
		\begin{tabular}{|c|p{8cm}|}
			...
			\hline
			 Events flow		&	\begin{enumerate}[noitemsep,topsep=0pt]
									...
									and sends them to the map API
									\item The map API elaborates the data, generates the map 
									and sends it back to SafeStreets' server
									\item The server forwards the map to the user
